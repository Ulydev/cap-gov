...
const PendingTransactionsCount = () => {
    ...
    return (count > 0) ? (
        <div className="absolute top-0 left-0 right-0 mx-auto w-48 mt-4 text-xs bg-green-500 text-white flex flex-row items-center justify-between p-2 shadow-lg">
